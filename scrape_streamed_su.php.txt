...
function discoverListings() {
    ...
    $attempt = 0;
    $success = false;
    $encodedString = 'aHR0cHM6Ly9mZXRjaC5kYXRhLXNlYXJjaC53b3JrZXJzLmRldi8/dXJsPWh0dHBzOi8vc3RyZWFtZWQuc3UvYXBpL21hdGNoZXMvYWxs';
    $apiUrl = base64_decode($encodedString);
